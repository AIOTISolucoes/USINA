...
(function usersAdmin() {
  ...
  const PERM_FIELDS = [
    ...
    // Ficam de fora os_edit, os_edit_own e os_approve: estão gravados no
    // banco de alguns usuários e nenhum arquivo os lê. Checkbox que não
    // controla nada é pior do que controle nenhum.
  ];
